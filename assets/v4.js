...
const FOOTNOTES = {
  ...
  22: '한국전력공사, 『분산전원 연계정보』 온라인 조회 — 읍면동 단위 잔여 연계가능용량(배전선로 vol3, 표준 연계한도 반영). 전국 5,066 읍면동, 수집 2026-07-27–28(재조달 08-19), 원시 5,066파일·26,801레코드 보존.<span class="fn-note">용도: 후보지 찾기 탭의 계통 여유 채색 — 참고 지표이며 정본 판정에 불사용. 같은 설비의 값 상이는 최솟값으로 보수 확정, 균등배분(하한)–공유 미조정(상한) 병기, 원천 무응답 589곳은 알 수 없음으로 병기.</span>',
  23: '국토교통부 V-World 데이터 API — 산업단지 경계 LT_C_DAMDAN(산업입지정보시스템 등재 전국 1,363개: 일반 763·농공 483·국가 65·도시첨단 52, 2026-08-20 수집) · 읍면동 경계 LT_C_ADEMD_INFO(5,067개, 2026-08-26 수집).<span class="fn-note">용도: 후보지 찾기 탭의 경계 표기 — 표기용 참조 자료로, 수치 산출에는 쓰지 않음. 신·구 행정코드는 법정동코드 자료·필지 대표점으로 대조.</span>',
